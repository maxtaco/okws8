...
CONSTANTS = 
  OK : [ 0 ]
	...
	RPC_CANTENCODEARGS   : [ 301,	"can't encode arguments" ]
	RPC_CANTDECODERES    : [ 302, "can't decode results" ]
	RPC_CANTSEND         : [ 303, "failure in sending call" ]
	RPC_CANTRECV         : [ 304, "failure in receiving result" ]
	RPC_TIMEDOUT         : [ 305, "call timed out" ]
  
	RPC_VERSMISMATCH     : [ 306, "rpc versions not compatible" ]
	RPC_AUTHERROR        : [ 307,	"authentication error" ]
	RPC_PROGUNAVAIL      : [ 308, "program not available" ]
	RPC_PROGVERSMISMATCH : [ 309, "program version mismatched" ]
	RPC_PROCUNAVAIL      : [ 310, "procedure unavailable" ]
	RPC_CANTDECODEARGS   : [ 311,	"decode arguments error" ]
	RPC_SYSTEMERROR      : [ 312, "generic 'other problem'" ]
	RPC_NOBROADCAST      : [ 321,	"Broadcasting not supported" ]
